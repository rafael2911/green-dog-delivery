package br.com.crcarvalho.delivery.carga;
...
public class RepositoryTest implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		Cliente fernando = new Cliente(ID_CLIENTE_FERNANDO, "Fernando", "Sampa");
		Cliente zePequeno = new Cliente(ID_CLIENTE_ZE_PEQUENO, "Zeh Pqueno", "Rio");
